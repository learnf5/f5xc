...
script_ver="1.6"
script_name="class7.sh"
student_name=$2

v_token=""
v_url="https://f5-training07.console.ves.volterra.io/api"
v_tenant="f5-training07-tfegvbar"
v_dom="f5training7.cloud"
v_aws_creds_name=""
...
echo ""
echo "Student numbers run from 701 to 712"
echo ""
...
echo "-adcreall12                ADMIN - Create all class labs for several students (max 12)"
...
echo ""
echo "Now make a connection to https://$1.$v_dom/test.exe"
echo ""
}
...
sleep 1
echo ""
echo "Now make a browser connection to http://$1-workload.$v_dom"
echo ""
...
### WAAP Lab 3 uses studentX-juice.f5training1.cloud
