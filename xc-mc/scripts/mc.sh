...
v_base64_cert=""
v_base64_key=""
v_beer_products="beerProducts.json"
...
f_mc_test()
{
curl -s -H "Authorization: APIToken $v_token" -X POST "$v_url/config/namespaces/$v_namespace_1/container_registrys" -d '{"metadata":{"name":"test-registry"},"spec":{"registry":"azure.microsoft.com/services/container-registry","user_name":"1e21992e-4283-4afe-9a89-b3b314f1fd55","password":{"clear_secret_info":{"url":"string:///dVUzOFF+SFZwS1RXYWU0eWVXYkxSblVwbHg2ZXprMm9xWmpNS2FWUg=="},"secret_encoding_type":"EncodingNone"}}}'
}
...
while [ $# -gt 0 ]; do
 case "$1" in
   ...
   ;;
   -s20)
   f_echo "Creating f5demos container registry ..."
   f_mc_s20
   ;;
   -s21)
