...
f_usage()
{
echo "Classroom 2 setup script for Deploying an Application to Microsoft Azure"
echo ""
...
sleep 1
echo ""
echo "Now make a browser connection to the f5trnapp application at https://$s_dom"
echo ""
...
f_log finish
f_echo "End ..."
student@pc18:~/f5xc/xc-admin-course/scripts$ ./azure2.sh
F5 Training F5 Distributed Cloud script Version 1.0
Classroom 2 setup script for Deploying an Application to Microsoft Azure

Student numbers run from 201 to 212

Usage: ./azure2.sh -option
...
-s5 <studentname>          Create lab 5 objects (HTTPS load balancer, Origin Pool, Origin Server)
-s6 <studentname>          Create lab 6 objects (HTTP load balancer)

student@pc18:~/f5xc/xc-admin-course/scripts$ cat azure2.sh
#!/bin/bash
...
v_token="29jFExLP3asWD7K+d8ZrM6K6GnM="
v_url="https://training2.console.ves.volterra.io/api"
v_tenant="training2-haiyaqtr"
v_dom="f5training2.cloud"
v_azure_creds_name="creds-azr1211gst01"
