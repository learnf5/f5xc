...
v_token="TRupCfxhI08CzaktknCrXwsrCmOPibI="
...
### v_token="HFdEu7Yp55Pfvon+MmLXpavWV7uAYXw="
...
echo ""
echo "-tok                       Test token"
echo "-mclst <studentname>       MC - List student AWS VPC"
echo "-mccre234 <studentname>    MC - Create labs 2-4 student objects"
echo "-mcapp4 <studentname>      MC - Apply AWS VPC site created in lab 4"
echo "-mccre8 <studentname>      MC - Create lab 8 student objects"
echo "-mccre10 <studentname>     MC - Create lab 10 student objects"
echo "-mccre11 <studentname>     MC - Create lab 11 student objects"
echo "-mclstd <studentname>      MC - List student vK8s deployments and other details"
...
while [ $# -gt 0 ]; do
 case "$1" in
   ...
   f_echo "Creating ADMIN lab 8 objects for $2 ..."
