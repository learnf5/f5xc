...
echo "-adstart <studentname>     ADMIN Start log collection on site"
echo "-adlog <studentname>       ADMIN Get (a) log for sitename"
echo "-adzip <studentname>       ** API does not work ** ADMIN Get the zip file of all logs for sitename"
echo ""
