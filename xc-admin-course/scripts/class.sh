...
exit 1
### curl -s -H "Authorization: APIToken $v_token" -X POST "$v_url/config/namespaces/$1/aws_vpc_sites" -d '{"metadata":{"name":"'$s_aws_vpc_name'","namespace":"'$1'"},"spec":{"aws_cred":{"name":"","tenant":""}"expressions":["'$s_key' in ('$s_value')"]},"site_type":"CUSTOMER_EDGE"}}'
}
