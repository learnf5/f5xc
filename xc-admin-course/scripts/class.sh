...
echo "-waapdso <studentname>     WAAP - Delete single student objects"
...
### curl -s -H "Authorization: APIToken $v_token" -X DELETE "$v_url/config/namespaces/$1/app_firewalls/$1-waf" | jq
sleep 2
echo "Deleting known HTTP Load balancers ..."
curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/http_loadbalancers" | jq -r .[][].name | grep -E $1
### curl -s -H "Authorization: APIToken $v_token" -X DELETE "$v_url/config/namespaces/$1/http_loadbalancers/$1-juice-lb" | jq
sleep 2
echo "Deleting Service Policies ..."
curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/service_policys" | jq -r .[][].name | grep -E $1
sleep 2
### curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/service_policys/$1-disallowed-md" | jq
sleep 2
### curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/service_policys/$1-geo-enforcement" | jq
sleep 2
### curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/service_policys/$1-ipaddr-allowed-md" | jq
sleep 2
### curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/service_policys/$1-sp-quarantine" | jq
sleep 2
echo "Deleting Malicious User Mitigations ..."
curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/malicious_user_mitigations" | jq -r .[][].name | grep -E $1
sleep 2
### curl -s -H "Authorization: APIToken $v_token" -X DELETE "$v_url/config/namespaces/$1/malicious_user_mitigations/$1-malicious-user-mitigations" | jq
sleep 2
echo "Deleting namespace ..."
curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/web/namespaces" | jq -r .[][].name | grep -E $1
sleep 2
