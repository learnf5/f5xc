...
### v_token="gfTa9F9igLid8gdh9ZJZNJAlLUOaxSs="
...
echo "-adcre <studentname>       ADMIN - Create labs 2-4 student objects"
echo "-adapp <studentname>       ADMIN - Apply AWS VPC site created in lab 4"
...
f_admin_create_single_student_objects()
{
...
while [ $# -gt 0 ]; do
 case "$1" in
   ...
   f_admin_create_single_student_objects $2
   ;;
   -adapp)
   if [ "$#" != 2 ]; then
    f_echo "Missing student name ... "
   ...
   f_admin_apply_single_student_objects $2
   ;;
   -wadso)
   if [ "$#" != 2 ]; then
    f_echo "Missing student name ... "
