...
v_token="Trfeu7Yp55Pfvon+MmLXpavWV7uAYXw="
...
echo "Has to be done after Lab 13, the OP name is dynamic"
echo "Service discovery is done through the k8s origin pool name"
curl -s -H "Authorization: APIToken $v_token" -X GET "$v_url/config/namespaces/$1/endpoints/ves-io-origin-pool-student14-k8s-57455d94bf" | jq
}
